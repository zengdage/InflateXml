...
public class TypedArray {
	XmlBlockParser mXml=new XmlBlockParser();
    public int[] mRsrcs;
    public int[] mData;
    public int[] mIndices;
    public int mLength;
        ...
        if (type == TypedValue.TYPE_STRING) {
            ...
            if (cookie < 0) {
                return mXml.getPooledString(
                    data[index+STYLE_DATA]).toString();
            }
        }
        return null;
    }
    ...
    public String getNonConfigurationString(int index, int allowedChangingConfigs) {
        ...
        final int[] data = mData;
        final int type = data[index+STYLE_TYPE];
        if ((data[index+STYLE_CHANGING_CONFIGURATIONS]&~allowedChangingConfigs) != 0) {
            return null;
        }
        if (type == TypedValue.TYPE_NULL) {
            return null;
    ...
    public boolean getBoolean(int index, boolean defValue) {
        ...
        TypedValue v = mValue;
        if (getValueAt(index, v)) {
            Log.w(TAG, "Converting to boolean: " + v);
    ...
    public float getFloat(int index, float defValue) {
        ...
        TypedValue v = mValue;
        if (getValueAt(index, v)) {
            Log.w(TAG, "Converting to float: " + v);
...
//            return mResources.loadColorStateList(value, value.resourceId);
    ...
    public float getDimension(int index, float defValue) {
        ...
        if (type == TypedValue.TYPE_NULL) {
            ...
            return TypedValue.complexToDimension(
                data[index+ STYLE_DATA], mResources.getDisplayMetrics());
        }
    ...
    public int getLayoutDimension(int index, String name) {
        ...
        if (type >= TypedValue.TYPE_FIRST_INT && type <= TypedValue.TYPE_LAST_INT) {
            ...
            return TypedValue.complexToDimensionPixelSize(data[index+ STYLE_DATA], mResources.getDisplayMetrics());
        }
    ...
    public float getFraction(int index, int base, int pbase, float defValue) {
        ...
        if (type == TypedValue.TYPE_NULL) {
            ...
            return TypedValue.complexToFraction(
                data[index+ STYLE_DATA], base, pbase);
        }
    ...
    private boolean getValueAt(int index, TypedValue outValue) {
        ...
        outValue.changingConfigurations = data[index+ STYLE_CHANGING_CONFIGURATIONS];
    ...
    private CharSequence loadStringValueAt(int index) {
       ...
       /* return mResources.getAssets().getPooledString(
            cookie, data[index+ STYLE_DATA]);*/
        return TAG+" loadStringValueAt ";
    }
    Resources mResources;
   public TypedArray(Context ctx, int[] data, int[] indices, int len) {
