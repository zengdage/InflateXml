...
@SuppressLint("NewApi")
public class YDCheckedTextView extends android.widget.CheckedTextView{
	private boolean isMarquee=false;
	private static final String TAG = "TextView";
	private Context context;
	public YDCheckedTextView(Context context, AttributeSet attrs) {
		super(context);
	...
	public void setAttributeSet(AttributeSet attrs){		
		...
		for(int i=0;i<count ;i++){
			...
			case style:
				...
				break;
			case checked:
				this.setChecked(attrs.getAttributeBooleanValue(i,false));
			case theme:
				break;
			default:
				break;
