...
@SuppressLint("NewApi")
public class YDExpandableListView extends android.widget.ExpandableListView {
    
	private Context context;
	public YDExpandableListView(Context context, AttributeSet attrs) {
		super(context);
		this.context=context;
		setAttributeSet(attrs);
	}
	public YDExpandableListView(Context context) {
		super(context);
	}
