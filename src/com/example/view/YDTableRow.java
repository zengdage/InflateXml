...
public class YDTableRow extends android.widget.TableRow implements Cloneable{
	private Context context;
	public YDTableRow(Context context, AttributeSet attrs) {
		super(context);
		this.context=context;
		setAttributeSet(attrs);
		
	}
	public YDTableRow(Context context) {
		super(context);
	}
    ...
    public ViewGroup clone() {  
		YDTableRow stu = null;  
        try{  
            stu = (YDTableRow)super.clone();   //浅复制  
