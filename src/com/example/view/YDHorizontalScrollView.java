...
public class YDHorizontalScrollView extends android.widget.HorizontalScrollView implements Cloneable{
	private Context context;
	public YDHorizontalScrollView(Context context, AttributeSet attrs) {
		super(context);
    ...
    public ViewGroup clone() {  
		YDHorizontalScrollView stu = null;  
        try{  
            stu = (YDHorizontalScrollView)super.clone();   //浅复制  
