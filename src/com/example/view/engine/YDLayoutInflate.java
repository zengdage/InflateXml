...
public  class YDLayoutInflate{
    ...
    */
     ...
     *        provides a set of Params values for root of the returned
     *        hierarchy (if <em>attachToRoot</em> is false.)
     * @param attachToRoot Whether the inflated hierarchy should be attached to
     *        the root parameter? If false, root is only used to create the
     *        correct subclass of Params for the root view in the XML.
    ...
    public final View createView(String name, String prefix, AttributeSet attrs)
        ...
        try {
            ...
            //如果allowedState为true,则已经装载过，无需再装载，只需获得实例便可。
     ...
     */
    private void rInflate(XmlPullParser parser, View parent, final AttributeSet attrs)throws XmlPullParserException, IOException {
