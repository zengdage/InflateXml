...
@SuppressLint("NewApi")
public class YDSurfaceView extends SurfaceView {
    public View view;
    private Context context;
	public YDSurfaceView(Context context, AttributeSet attrs) {
		super(context);
		this.context=context;
		setAttributeSet(attrs);
	}
	
	public YDSurfaceView(Context context,View view) {
		super(context);
		this.view=view;
	}
	...
	public View findViewByID(String idString){
        return view.findViewById(YDResource.getInstance().getIDWithString(idString));
		//return YDResource.getInstance().getViewByID(idString,YDResource.getInstance().getIDMap(view));
	}
