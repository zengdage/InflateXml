...
public class YDCheckBox extends android.widget.CheckBox {

	private static final String TAG = "Button";
	private Context context;
	public YDCheckBox(Context context, AttributeSet attrs) {
		super(context);
...
public void setAttributeSet(AttributeSet attrs){	
		...
		for(int i=0;i<count ;i++){
			...
			case background:
				...
				break;
			case checked:
				this.setChecked(attrs.getAttributeBooleanValue(i,true));		
				break;
			case style:
