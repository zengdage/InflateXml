...
public class YDProgressBar extends ProgressBar {
	...
	public YDProgressBar(Context context, AttributeSet attrs) {
		super(context);
	...
	public void setAttributeSet(AttributeSet attrs){		
		...
		for(int i=0;i<count ;i++){
			...
			case scrollbars:
				...
				break;
			case max:
				this.setMax(attrs.getAttributeIntValue(i,100));
			case progress:
			    this.setProgress(attrs.getAttributeIntValue(i,0));
				break;
			case secondaryProgress:
				this.setSecondaryProgress(attrs.getAttributeIntValue(i,0));
				break;
