...
@SuppressLint("NewApi")
public class YDActionMenuView extends android.widget.ActionMenuView {
    
	private Context context;
	public YDActionMenuView(Context context, AttributeSet attrs) {
		super(context);
		this.context=context;
		setAttributeSet(attrs);
	}
	public YDActionMenuView(Context context) {
		super(context);
	}
